...
<head>
    ...
    <style>
        ...
        #carrusel .carousel-item img {
            ...
            width: 100%;
            max-height: 600px;
            /* Se eliminó: filter: brightness(0.8); */
        }
...
<body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="d-none d-lg-flex align-items-center">
                    ...
                    <a href="#" class="btn fw-bold" style="background-color: var(--color-pink); color: #fff;">
                        Oportunidades
                    </a>
                </div>
            </div>
                ...
                @forelse($videos as $video)
                    <div class="col-md-4">
                        <div class="card shadow-sm" style="border-radius: 1rem; overflow: hidden;">
                            ...
                            <div class="d-flex align-items-center p-3 bg-white" style="border-bottom: 1px solid #ddd;">
                            ...
                            <!-- Cuerpo: video en loop (estilo GIF) -->
    ...
    @php
    // Si no se ha pasado $contact, se usan valores por defecto
...
<footer class="footer-custom" style="background-color: var(--color-cyan);">
        ...
        <div class="row text-center text-md-start">
            ...
            <div class="col-md-3 mb-3">
                ...
                <ul class="list-unstyled mt-2">
                    <li>
                    <a href="{{ route('landing.empresa') }}" class="text-white text-decoration-none">Nuestra empresa</a>
                    </li>
                    <li>
                    <a href="{{ route('landing.locales') }}" class="text-white text-decoration-none">Locales</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-3 mb-3">
                ...
                <ul class="list-unstyled mt-2">
                    <li>
                    <a href="{{ route('reservation.create') }} " class="text-white text-decoration-none">Reservar</a>
                    </li>
                </ul>
            </div>
            ...
            <!-- Columna 4: Contacto (Editable en el backoffice) -->
            <div class="col-md-3 mb-3">
